...
var firstFileName = fileList[0];
if (firstFileName.indexOf("colorMap")>-1) {
...
for(/*i is already present*/;i<fileList.length;i++){
...
var colors = frameObject.colors;
var indices = frameObject.indices;
var uvs =  frameObject.uvs;
var normals = frameObject.normals;
